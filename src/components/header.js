        ...
        <div className='p-2 max-w-4xl mx-auto  flex items-center justify-between '>
          ...
          {user ? (
            ...
            <div className='flex gap-3 items-center'>
              <Link
                to='/login'
                className='bg-blue-500  font-semibold text-sm py-1 px-3 rounded'
              >
                Login
              </Link>
              <Link
                      ...
                      <form onSubmit={uploadImage}>
                        {uploading ? (
                          <div className='rounded my-3 overflow-hidden w-full bg-gray-200'>
                            <div
                              className='h-1 bg-blue-medium rounded transition-all'
                        ...
                        {images && (
                          <>
                            ...
                            >
                              <button
                                className='bg-blue-medium px-4 py-1 text-white
                       font-semibold text-sm rounded block text-center 
